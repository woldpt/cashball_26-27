...
- **CupUpsetModal sem auto-fecho:** removido timeout de 8 s (`AUTO_CLOSE_MS` + `useEffect`); o modal só fecha via botão "Continuar". Guard de identidade (revelar com payload novo) mantém-se.
