...
- Reparação da sala viva (SQL one-off, a correr na produção — ver resposta final): diagnóstico + DELETE da linha órfã (a que ficar fora do conjunto de 4 que cobre 8 equipas distintas); depois é só dar Ready para a ronda 4 sortear.
