...
export function WelcomeModal({ welcomeModal, me, setWelcomeModal }) {
  if (!welcomeModal || !me?.teamId) return null;
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-2xl bg-zinc-900/90 border border-emerald-900/40 rounded-xl shadow-2xl overflow-hidden flex flex-col sm:flex-row">
          ...
          <div className="text-center">
            ...
            {welcomeModal.division != null && (
              <span
                ...
                style={{
                  borderColor: (welcomeModal.colorPrimary || "#2d6a4f") + "60",
