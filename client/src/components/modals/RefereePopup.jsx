      ...
      >
        ...
        <div className="p-5 space-y-4">
          ...
          <p className="text-sm text-zinc-400 leading-relaxed">
            ...
            partida. Valores acima de 50 favorecem a tua equipa; abaixo de 50
            favorecem o adversário. Isso pode mexer nos cartões e nos penaltis
            assinalados.
          </p>
          <button
            type="button"
