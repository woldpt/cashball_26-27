        ...
        <div className="relative shrink-0 bg-surface-container overflow-hidden">
          ...
          <div className="relative flex items-start gap-2 sm:gap-4 px-3 sm:px-6 pt-3 sm:pt-6 pb-3 sm:pb-5">
            <div className="shrink-0">
              <PlayerAvatar seed={player.id} position={pos} teamColor={player.team_color_primary || player.color_primary || null} nationality={player.nationality} size="w-10 h-10 sm:w-24 sm:h-24" />
            </div>
