	...
	return (
		...
		>
			<div className="max-w-7xl mx-auto px-6 lg:px-10 h-16 flex items-center justify-between">
				...
				<div className="flex items-center gap-2 bg-landing-accent-strong/10 border border-landing-accent-strong/20 px-3 py-1.5 rounded-full">
					<span className="w-1.5 h-1.5 rounded-full bg-landing-accent animate-pulse shadow-[0_0_6px_rgba(52,211,153,0.8)]" />
					<span className="text-[10px] font-black uppercase tracking-[0.3em] text-landing-accent hidden sm:block">
