 ...
 */
const LandingFooter = () => (
	<footer className="relative z-10 border-t border-outline-variant/20 bg-bg py-5 short:py-3">
		<div className="max-w-7xl mx-auto px-6 lg:px-10 flex items-center justify-between">
			...
			<span className="text-xs text-on-surface-variant/60">{APP_VERSION} © 2026 by Fábio Silva</span>
		</div>
	</footer>
);
