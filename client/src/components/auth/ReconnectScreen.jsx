...
const ReconnectScreen = ({ me }) => (
	<div className="min-h-screen bg-landing-surface text-white flex flex-col items-center justify-center p-6 pb-24">
		...
		<motion.div
			...
			className="relative bg-landing-panel-alt/80 border border-green-500/20 backdrop-blur-xl p-8 short:p-5 rounded-2xl w-full max-w-md shadow-[0_0_60px_rgba(74,222,128,0.08)] text-center"
		>
			...
			<div className="w-12 h-12 mx-auto mb-4 rounded-full bg-green-500/10 border border-green-500/30 flex items-center justify-center">
				<span
					className="material-symbols-outlined text-green-400 text-2xl animate-spin"
