...
const LandingBackground = () => (
	<div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
		...
		<div
			...
			style={{
				background:
					"repeating-linear-gradient(90deg, rgba(52,211,153,0.028) 0 120px, transparent 120px 240px)",
			}}
		/>
		...
		<div
			...
			style={{
				background: `
					radial-gradient(circle 350px at 50% 50%, rgba(52,211,153,0.04), transparent 70%),
