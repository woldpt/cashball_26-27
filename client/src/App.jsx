...
function App() {
	...
	const renewPlayerContract = useCallback(
		(player) => {
	...
	const listPlayerAuction = useCallback(
		(player) => {
	...
	const listPlayerFixed = useCallback(
		(player) => {
	...
	const removeFromTransferList = useCallback(
		(player) => {
			setGameDialog({
				mode: "confirm",
