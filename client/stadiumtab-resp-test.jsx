// StadiumTab mobile responsiveness harness — renders the REAL StadiumTab with
...
// ── Fixture: edge cases ─────────────────────────────────────────────────────
// - nome de estádio longo; divisão baixa; capacidade a 1 obra do máximo
// - moral baixa (30 → vermelho), bilhete caro (30€), fanbase grande
// - assistência média quase lotação (occupancy >95% → terciário)
const teamInfo = {
  id: 1,
  ...
  ticket_price: 30,
  fanbase: 1234567,
  stadium_name: "Estádio Municipal Dr. José Gomes da Silva Filho",
  stadium_capacity: 115000,
};

const financeData = {
  allTimeHomeMatches: 42,
  allTimeTotalAttendance: 4600000,
};
